...
com.loadImages = function(stype){
    ...
    //绘制棋盘
    com.bgImg = new Image();
    com.bgImg.src  = "../images/chess/"+stype+"/bg.png";

    //提示点
    com.dotImg = new Image();
    com.dotImg.src  = "../images/chess/"+stype+"/dot.png";

    //棋子
    for (var i in com.args){
        com[i] = {};
        com[i].img = new Image();
        com[i].img.src = "../images/chess/"+stype+"/"+ com.args[i].img +".png";
    }

    //棋子外框
    com.paneImg = new Image();
    com.paneImg.src  = "../images/chess/"+stype+"/r_box.png";

    document.getElementsByTagName("body")[0].style.background= "url(../images/chess/"+stype+"/bg.jpg)";
