...
define("scripts/factory/fruit.js", function(exports){
	...
	var infos = {
		boom: [ "../images/fruit/fruit/boom.png", 66, 68, 26, 0, 0, null ],
		peach: [ "../images/fruit/fruit/peach.png", 62, 59, 37, -50, 0, "#e6c731" ],
		sandia: [ "../images/fruit/fruit/sandia.png", 98, 85, 38, -100, 0, "#c00" ],
		apple: [ "../images/fruit/fruit/apple.png", 66, 66, 31, -54, 0, "#c8e925" ],
		banana: [ "../images/fruit/fruit/banana.png", 126, 50, 43, 90, 0, null ],
		basaha: [ "../images/fruit/fruit/basaha.png", 68, 72, 32, -135, 0, "#c00" ]
	};
	...
	ClassFruit.prototype.set = function( hide ){
		...
		this.shadow = layer.createImage( "fruit", "images/fruit/shadow.png", this.startX - radius, this.startY - radius + shadowPos, 106, 77 );
...
define("scripts/object/background.js", function(exports){
	...
	exports.set = function(){
		image = layer.createImage( "default", "../images/fruit/background.jpg", 0, 0, 640, 480 );
	};
...
define("scripts/object/developing.js", function(exports){
	...
	exports.anims = [];
	exports.set = function(){
		this.image = layer.createImage( "default", "../images/fruit/developing.png", 103, 218, 429, 53 ).hide().scale( 1e-5, 1e-5 );
	};
...
define("scripts/object/dojo.js", function(exports){
	...
	var tween = require("scripts/lib/tween");
	exports = rotate.create("../images/fruit/dojo.png", 41, 240, 175, 175, 1e-5, tween.exponential.co, 500);;
	return exports;
});
...
define("scripts/object/flame.js", function(exports){
	...
	exports.create = function( ox, oy, start ){
		...
		var nx = ox, ny = oy;
		var image = layer.image("../images/fruit/smoke.png", nx - 21, ny - 21, 43, 43).hide();
		var flames = {};
...
define("scripts/object/flash.js", function(exports){
	...
	exports.set = function(){
		image = layer.createImage( "flash", "../images/fruit/flash.png", 0, 0, 358, 20 ).hide();
...
define("scripts/object/game-over.js", function(exports){
	...
	exports.anims = [];
	exports.set = function(){
		this.image = layer.createImage( "default", "../images/fruit/game-over.png", 75, 198, 490, 85 ).hide().scale( 1e-5, 1e-5 );
	};
...
define("scripts/object/home-desc.js", function(exports){
	...
	var tween = require("scripts/lib/tween");
	exports = displacement.create("../images/fruit/home-desc.png", 161, 91, -161, 140, 7, 127, tween.exponential.co, 500);;
	return exports;
});
...
define("scripts/object/home-mask.js", function(exports){
	var displacement = require("scripts/factory/displacement");
	var tween = require("scripts/lib/tween");
	exports = displacement.create("../images/fruit/home-mask.png", 640, 183, 0, -183, 0, 0, tween.exponential.co, 1e3);;
	return exports;
});
...
define("scripts/object/logo.js", function(exports){
	var displacement = require("scripts/factory/displacement");
	var tween = require("scripts/lib/tween");
	exports = displacement.create("../images/fruit/logo.png", 288, 135, 17, -182, 17, 1, tween.exponential.co, 1e3);;
...
define("scripts/object/lose.js", function(exports){
	...
	var conf1 = { src: "../images/fruit/x.png", sx: 650, ex: 561, y: 5, w: 22, h: 19 };
	var conf2 = { src: "../images/fruit/xx.png", sx: 671, ex: 582, y: 5, w: 27, h: 26 };
	var conf3 = { src: "../images/fruit/xxx.png", sx: 697, ex: 608, y: 6, w: 31, h: 32 };
	var number = 0;
	exports.anims = [];
	exports.set = function(){
	...
	function createPosShow( x ){
	    var image = layer.createImage( "default", "../images/fruit/lose.png", x - 27, 406, 54, 50 ).scale( 1e-5, 1e-5 );
	    var duration = 500;
...
define("scripts/object/new-game.js", function(exports){
	var rotate = require("scripts/factory/rotate");
	var tween = require("scripts/lib/tween");
	exports = rotate.create("../images/fruit/new-game.png", 244, 231, 195, 195, 1e-5, tween.exponential.co, 500);;
	return exports;
});
...
define("scripts/object/new.js", function(exports){
	...
	exports.anims = [];
	exports.set = function(){
	    image = layer.createImage( "default", "../images/fruit/new.png", sx, sy, sw, sh );
	};
...
define("scripts/object/ninja.js", function(exports){
	var displacement = require("scripts/factory/displacement");
	var tween = require("scripts/lib/tween");
	exports = displacement.create("../images/fruit/ninja.png", 244, 81, 315, -140, 315, 43, {
...
define("scripts/object/quit.js", function(exports){
	var rotate = require("scripts/factory/rotate");
	var tween = require("scripts/lib/tween");
	exports = rotate.create("../images/fruit/quit.png", 493, 311, 141, 141, 1e-5, tween.exponential.co, 500);;
	return exports;
});
...
define("scripts/object/score.js", function(exports){
	...
	exports.anims = [];
	exports.set = function(){
	    image = layer.createImage( "default", "../images/fruit/score.png", imageSx, 8, 29, 31 ).hide();
